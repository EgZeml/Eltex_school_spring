...
// Для этого задания были реализованы две функции в contacts_file.c
// load_contacts - читает данные и заполняет книгу контактов
// save_contacts - сохраняет данные книги в файл при выходе
int main () {
    ...
    if (load_contacts(&book, "contacts.dat") < 0) {
        printf("Не удалось загрузить сохранённые контакты.\n");
        return 1;
    }
    ...
    do {
        ...
        switch (choice) {
            ...
            case 5:
                ...
                break;
            case 0:
                printf("Сохраняю и выхожу...\n");
                if (save_contacts(&book, "contacts.dat") < 0) {
